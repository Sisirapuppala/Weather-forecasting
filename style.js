            ...
            switch (description) {
                case "clear sky":
                    document.body.style.background =
                        "url(/img/weather-clear-sky.jpg)";
                    document.body.style.backgroundSize = "cover";
                    document.body.style.backgroundRepeat = "no-repeat";
                    break;
                case "cloudy":
                    document.body.style.background =
                        "url(/img/weather-cloudy.jpg)";
                    document.body.style.backgroundSize = "cover";
                    document.body.style.backgroundRepeat = "no-repeat";
                ...
                case "broken clouds":
                    document.body.style.background =
                        "url(/img/weather-broken-cloud.jpg)";
                    document.body.style.backgroundSize = "cover";
                    document.body.style.backgroundRepeat = "no-repeat";
                ...
                case "thunderstrome":
                    document.body.style.background =
                        "url(img/weather-thunderstrome.jpg)";
                    document.body.style.backgroundSize = "cover";
                    document.body.style.backgroundRepeat = "no-repeat";
                    break;
                case "snow":
                    document.body.style.background =
                        "url(img/weather-snow.jpg)";
                    document.body.style.backgroundSize = "cover";
                    document.body.style.backgroundRepeat = "no-repeat";
                    break;
                case "mist":
                    document.body.style.background =
                        "url(img/weather-mist.jpg)";
                    document.body.style.backgroundSize = "cover";
                    document.body.style.backgroundRepeat = "no-repeat";
                    break;
                case "haze":
